...
_COMPANION_SUMMARY_SYSTEM = (
    ...
    "'the editor', 'an unidentified source', 'a colleague at the paper'. "
    "NEVER invent or supply a proper name that does not appear verbatim in the transcript. "
    "Example — WRONG: 'Camille Fontenot tipped off Calloway.' "
    "Example — RIGHT: 'An unidentified colleague tipped off Calloway.' "
    "\n\n"
    ...
    "ABSOLUTE RULE: NO facts. No names. No case details. No locations. No events. No plot. "
    "WRONG: 'The detective and partner discussed the Flood case and a witness named Dupré.' "
    "RIGHT: 'The partner held back; the detective pushed, and the distance between them narrowed.' "
    "If you find yourself writing a name, a place, or a thing that happened — stop and rewrite.\n"
    "\"npc_opinion\": null\n"
